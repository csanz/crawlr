...
export function initKeyboardHelp() {
    ...
    hint.style.cssText = 'position:absolute; bottom:10px; left:10px; z-index:100; color:rgba(255,255,255,0.7); font:13px monospace; cursor:pointer; user-select:none; text-shadow:0 0 4px rgba(0,0,0,0.8);';
